      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        <div className="flex justify-center gap-6 mb-8">
          <a
            ...
            className="text-parchment/40 hover:text-rust transition-colors"
            aria-label="GitHub"
          >
        ...
        <p className="font-display text-lg text-parchment/60 mb-3">
          Built in Arkansas. Deployed everywhere.
        </p>
