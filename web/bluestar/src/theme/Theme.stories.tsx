  ...
  return (
    <div className={containerClass}>
      ...
      <section className={sectionClass}>
        ...
        <h3 style={{ fontSize: theme.typography.fontSize.lg, marginTop: theme.spacing.xl, marginBottom: theme.spacing.md }}>
          Primary
        </h3>
      ...
      <section className={sectionClass}>
        ...
        {Object.entries(theme.typography.fontSize).map(([name, size]) => (
          <div key={name} style={{ marginBottom: theme.spacing.sm }}>
            <span className={valueClass} style={{ marginRight: theme.spacing.md }}>{name}: {size}</span>
        ...
        {Object.entries(theme.typography.fontWeight).map(([name, weight]) => (
          <div key={name} className={typographyExampleClass(theme.typography.fontSize.base, weight, theme.typography.lineHeight.normal)}>
      ...
      <section className={sectionClass}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: theme.spacing.lg, flexWrap: 'wrap' }}>
        ...
        <div className={colorGridClass}>
          {Object.entries(theme.shadows).map(([name, shadow]) => (
            <div key={name} className={shadowBoxClass(shadow)}>
              <div className={labelClass}>{name}</div>
              <div className={valueClass} style={{ marginTop: theme.spacing.sm, wordBreak: 'break-all' }}>
                {shadow}
              </div>
            </div>
          ))}
